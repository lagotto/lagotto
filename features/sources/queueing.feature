...
Feature: Background queueing
  ...
  Background:
    ...
    And that we have 20 stale articles for "Citeulike"
    And that we have 5 refreshed articles for "Citeulike"
    ...
    Scenario Outline: Queue all articles if the source is active
      ...
      And that we have queued all articles for "Citeulike"
      When I go to the "Jobs" tab of the Sources page
    ...
    Scenario: Queue all stale articles
      Given that we have queued all stale articles for "Citeulike"
      When I go to the "Jobs" tab of the Sources page
    ...
    Scenario: Queue one article
      Given that we have queued one article for "Citeulike"
      When I go to the "Jobs" tab of the Sources page
