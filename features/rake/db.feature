Feature: Manage ALM Database
  I should be able to manage ALM content via the command line
    ...
    #   When I run `rake db:error_messages:delete` interactively
    ...
    #   When I run `rake db:api_requests:delete` interactively
    #   Then the output should contain "Deleted 3 API requests, 0 API requests remaining"