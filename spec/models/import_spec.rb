...
describe Import do
  ...
  context "query_url" do
    it "should have default query_url" do
      import = Import.new
      url = "http://api.crossref.org/works?filter=from-update-date%3A2013-09-04%2Cuntil-update-date%3A2013-09-04%2Cuntil-pub-date%3A2013-09-05&offset=0&rows=1000"
    ...
    it "should have query_url with from_update_date" do
      ...
      url = "http://api.crossref.org/works?filter=from-update-date%3A2013-09-01%2Cuntil-update-date%3A2013-09-04%2Cuntil-pub-date%3A2013-09-05&offset=0&rows=1000"
      import.query_url.should eq(url)
    end
    ...
    it "should have query_url with member_id" do
      ...
      url = "http://api.crossref.org/works?filter=from-update-date%3A2013-09-04%2Cuntil-update-date%3A2013-09-04%2Cuntil-pub-date%3A2013-09-05%2Cmember%3A340&offset=0&rows=1000"
      import.query_url.should eq(url)
    end

    it "should have query_url with type" do
      import = Import.new(type: 'book-entry')
      url = "http://api.crossref.org/works?filter=from-update-date%3A2013-09-04%2Cuntil-update-date%3A2013-09-04%2Cuntil-pub-date%3A2013-09-05%2Ctype%3Abook-entry&offset=0&rows=1000"
      import.query_url.should eq(url)
    end

    it "should have query_url with issn" do
      import = Import.new(issn: '1545-7885')
      url = "http://api.crossref.org/works?filter=from-update-date%3A2013-09-04%2Cuntil-update-date%3A2013-09-04%2Cuntil-pub-date%3A2013-09-05%2Cissn%3A1545-7885&offset=0&rows=1000"
      import.query_url.should eq(url)
    end

    it "should have query_url with sample" do
      import = Import.new(sample: 100)
      url = "http://api.crossref.org/works?filter=from-update-date%3A2013-09-04%2Cuntil-update-date%3A2013-09-04%2Cuntil-pub-date%3A2013-09-05&sample=100"
      import.query_url.should eq(url)
    end

    it "should have query_url with offset" do
      import = Import.new
      url = "http://api.crossref.org/works?filter=from-update-date%3A2013-09-04%2Cuntil-update-date%3A2013-09-04%2Cuntil-pub-date%3A2013-09-05&offset=250&rows=1000"
      import.query_url(offset = 250).should eq(url)
    end

    it "should have query_url with rows" do
      import = Import.new
      url = "http://api.crossref.org/works?filter=from-update-date%3A2013-09-04%2Cuntil-update-date%3A2013-09-04%2Cuntil-pub-date%3A2013-09-05&offset=0&rows=250"
  ...
  context "get_data" do
    ...
    it "should get_data access denied error" do
      ...
      error = "the server responded with status 401 for http://api.crossref.org/works?filter=from-update-date%3A2013-09-04%2Cuntil-update-date%3A2013-09-04%2Cuntil-pub-date%3A2013-09-05&offset=0&rows=1000"
    ...
    it "should get_data timeout error" do
      ...
      response = import.get_data
      response.should eq(error: "the server responded with status 408 for http://api.crossref.org/works?filter=from-update-date%3A2013-09-04%2Cuntil-update-date%3A2013-09-04%2Cuntil-pub-date%3A2013-09-05&offset=0&rows=1000")
      stub.should have_been_requested
