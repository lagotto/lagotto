...
describe Import do
  ...
  context "query_url" do
    it "should have default query_url" do
      import = Import.new
      url = "http://api.crossref.org/works?filter=from-index-date%3A2013-09-04%2Cuntil-index-date%3A2013-09-04%2Ctype%3Ajournal-article&offset=0&rows=1000"
    ...
    it "should have query_url with from_index_date" do
      ...
      url = "http://api.crossref.org/works?filter=from-index-date%3A2013-09-01%2Cuntil-index-date%3A2013-09-04%2Ctype%3Ajournal-article&offset=0&rows=1000"
      import.query_url.should eq(url)
    end

    it "should have query_url with until_index_date" do
      import = Import.new(until_index_date: "2013-09-05")
      url = "http://api.crossref.org/works?filter=from-index-date%3A2013-09-04%2Cuntil-index-date%3A2013-09-05%2Ctype%3Ajournal-article&offset=0&rows=1000"
      import.query_url.should eq(url)
    end

    it "should have query_url with member_id" do
      import = Import.new(member: 340)
      url = "http://api.crossref.org/works?filter=from-index-date%3A2013-09-04%2Cuntil-index-date%3A2013-09-04%2Ctype%3Ajournal-article%2Cmember%3A340&offset=0&rows=1000"
      import.query_url.should eq(url)
    end

    it "should have query_url with type" do
      import = Import.new(type: 'book-entry')
      url = "http://api.crossref.org/works?filter=from-index-date%3A2013-09-04%2Cuntil-index-date%3A2013-09-04%2Ctype%3Abook-entry&offset=0&rows=1000"
      import.query_url.should eq(url)
    end

    it "should have query_url with issn" do
      import = Import.new(issn: '1545-7885')
      url = "http://api.crossref.org/works?filter=from-index-date%3A2013-09-04%2Cuntil-index-date%3A2013-09-04%2Ctype%3Ajournal-article%2Cissn%3A1545-7885&offset=0&rows=1000"
      import.query_url.should eq(url)
    end
    ...
    it "should have query_url with offset" do
      import = Import.new
      url = "http://api.crossref.org/works?filter=from-index-date%3A2013-09-04%2Cuntil-index-date%3A2013-09-04%2Ctype%3Ajournal-article&offset=250&rows=1000"
  ...
  context "get_data" do
    ...
    it "should get_data access denied error" do
      ...
      error = "the server responded with status 401 for http://api.crossref.org/works?filter=from-index-date%3A2013-09-04%2Cuntil-index-date%3A2013-09-04%2Ctype%3Ajournal-article&offset=0&rows=1000"
    ...
    it "should get_data timeout error" do
      ...
      response = import.get_data
      response.should eq(error: "the server responded with status 408 for http://api.crossref.org/works?filter=from-index-date%3A2013-09-04%2Cuntil-index-date%3A2013-09-04%2Ctype%3Ajournal-article&offset=0&rows=1000")
      stub.should have_been_requested
