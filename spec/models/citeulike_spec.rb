...
describe Citeulike do
  ...
  context "use the CiteULike API" do
    it "should report if there are no events and event_count returned by the CiteULike API" do
      ...
      subject.parse_data(article_without_events).should eq(events: [], events_url: subject.get_events_url(article_without_events), event_count: 0, event_metrics: { pdf: nil, html: nil, shares: 0, groups: nil, comments: nil, likes: nil, citations: nil, total: 0 })
