...
describe Nature do
  ...
  context "use the Nature Blogs API" do
    it "should report if there are no events and event_count returned by the Nature Blogs API" do
      ...
      subject.get_data(article_without_events).should eq(events: [], event_count: 0, event_metrics: { pdf: nil, html: nil, shares: nil, groups: nil, comments: nil, likes: nil, citations: 0, total: 0 })
