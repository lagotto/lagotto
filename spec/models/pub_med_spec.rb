...
describe PubMed, type: :model, vcr: true do
  ...
  context "parse_data" do
    ...
    it "should report if there are events and event_count returned by the PubMed API" do
      ...
      expect(event['author']).to eq([{"affiliation"=>[], "family"=>"Morrison", "given"=>"Shaun F."}, {"affiliation"=>[], "family"=>"Madden", "given"=>"Christopher J."}, {"affiliation"=>[], "family"=>"Tupone", "given"=>"Domenico"}])
