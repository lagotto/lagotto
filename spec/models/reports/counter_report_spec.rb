...
describe CounterReport do
  ...
  describe "#line_items" do
    describe "when there are no Counter retrieval_statuses or works" do
      it "returns an empty array" do
        expect(report.line_items).to eq([])
      end
    end

    describe "when there are Counter retrieval_statuses for works" do
    ...
    describe "when there are retrieval_statuses for works for sources other than Counter" do
      let!(:retrieval_statuses){ [
      ...
      it "does not include non-Counter sources" do
