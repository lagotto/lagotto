  ...
  context "caching", :caching => true do
    ...
    context "index" do
      ...
      it "can cache works" do
        ...
        expect(response_source["metrics"][:total].to_i).to eql(work.aggregations.first.total)
    ...
    context "work is updated" do
      ...
      it "does not use a stale cache when the info query parameter changes" do
        ...
        expect(response_source["metrics"]["total"]).to eq(work.aggregations.first.total)
        expect(response_source["metrics"]["readers"]).to eq(work.aggregations.first.total)
