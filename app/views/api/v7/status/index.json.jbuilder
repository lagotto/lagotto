...
json.status @status do |status|
  json.cache! ['v7', status, current_user], skip_digest: true do
    json.(status, :id, :works_count, :works_new_count, :relations_count, :contributors_count, :publishers_count, :agents, :results_count, :responses_count, :deposits_count, :requests_count, :requests_average, :version)
