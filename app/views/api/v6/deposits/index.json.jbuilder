...
json.deposits @deposits do |deposit|
  json.cache! ['v6', deposit], skip_digest: true do
    json.(deposit, :id, :state, :message_type, :message_action, :source_token, :callback, :prefix, :subj_id, :obj_id, :relation_type_id, :source_id, :publisher_id, :total, :occurred_at, :timestamp, :subj, :obj)
  end
end
