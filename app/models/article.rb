class Article < ActiveRecord::Base
  ...
  def to_xml(options = {})
    ...
    xml.tag!("article", :doi => doi, :citations_count => citations_count,:pub_med => pub_med,:pub_med_central => pub_med_central, :updated_at => retrieved_at, :published => published_on) do
