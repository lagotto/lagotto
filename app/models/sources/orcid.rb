class Orcid < Source
  ...
  def url
    config.url || "http://pub.orcid.org/v1.1/search/orcid-bio/?q=digital-object-ids:\"%{doi}\""
  end

  def events_url
    config.events_url || "https://orcid.org/orcid-search/quick-search/?searchQuery=\"%{doi}\""
  end
end
