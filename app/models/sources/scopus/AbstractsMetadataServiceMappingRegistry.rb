...
module AbstractsMetadataServiceMappingRegistry
  ...
  NsV10 = "http://webservices.elsevier.com/schemas/metadata/abstracts/types/v10"
  ...
  EncodedRegistry.register(
    :class => CacheInfoType,
    :schema_type => XSD::QName.new(NsV10, "CacheInfoType"),
    :schema_element => [
  ...
  EncodedRegistry.register(
    ...
    :schema_type => XSD::QName.new(NsV10, "GetPublishersReqPayloadType"),
    :schema_element => [
  ...
  EncodedRegistry.register(
    ...
    :schema_type => XSD::QName.new(NsV10, "GetPublishersType"),
    :schema_element => [
  ...
  EncodedRegistry.register(
    :class => PublisherType,
    :schema_type => XSD::QName.new(NsV10, "PublisherType"),
    :schema_element => [
  ...
  EncodedRegistry.register(
    ...
    :schema_type => XSD::QName.new(NsV10, "PublisherListType"),
    :schema_element => [
  ...
  EncodedRegistry.register(
    ...
    :schema_type => XSD::QName.new(NsV10, "GetPublishersRspPayloadType"),
    :schema_element => [
  ...
  EncodedRegistry.register(
    ...
    :schema_type => XSD::QName.new(NsV10, "GetPublishersResponseType"),
    :schema_element => [
  ...
  EncodedRegistry.register(
    ...
    :schema_type => XSD::QName.new(NsV10, "GetSourceMetadataReqPayloadType"),
    :schema_element => [
      ["cidQualifier", "CIDQualifierType", [0, 1]],
      ["absMetSource", "AbsMetSourceType"],
      ["responseStyle", "ResponseStyleType"],
  ...
  EncodedRegistry.register(
    ...
    :schema_type => XSD::QName.new(NsV10, "GetSourceMetadataType"),
    :schema_element => [
  ...
  EncodedRegistry.register(
    ...
    :schema_type => XSD::QName.new(NsV10, "GetSourceMetadataRspPayloadType"),
    :schema_element => [
      ["cacheInfo", "CacheInfoType", [0, 1]],
      ["metricsTimestamp", "SOAP::SOAPString", [0, 1]],
  ...
  EncodedRegistry.register(
    ...
    :schema_type => XSD::QName.new(NsV10, "GetSourceMetadataResponseType"),
    :schema_element => [
      ["status", "MetaDataStatusType"],
  ...
  EncodedRegistry.register(
    ...
    :schema_type => XSD::QName.new(NsV10, "AbstractsListType"),
    :schema_element => [
  ...
  EncodedRegistry.register(
    :class => AbstractsType,
    :schema_type => XSD::QName.new(NsV10, "AbstractsType"),
    :schema_element => [
      ["collectionList", "CollectionListType", [0, 1]],
      ["abstractsId", nil, [0, 1]],
      ["gid", nil, [0, 1]],
  ...
  EncodedRegistry.register(
    ...
    :schema_type => XSD::QName.new(NsV10, "CoverageRangeType"),
    :schema_element => [
  ...
  EncodedRegistry.register(
    ...
    :schema_type => XSD::QName.new(NsV10, "ISBNWrapperType"),
    :schema_element => [
      ["isbn", nil],
      ["length", nil, [0, 1]]
    ]
  ...
  EncodedRegistry.register(
    ...
    :schema_type => XSD::QName.new(NsV10, "MetricListType"),
    :schema_element => [
      ["metric", "MetricType[]", [0, nil]]
    ]
  )

  EncodedRegistry.register(
    :class => MetricType,
    :schema_type => XSD::QName.new(NsV10, "MetricType"),
    :schema_element => [
  ...
  EncodedRegistry.register(
    ...
    :schema_type => XSD::QName.new(NsV10, "RelationshipType"),
    :schema_element => [
  ...
  EncodedRegistry.register(
    ...
    :schema_type => XSD::QName.new(NsV10, "SubjectAreaListType"),
    :schema_element => [
      ["subjectArea", ["SubjectAreaType[]", XSD::QName.new(NsV10, "SubjectArea")], [1, nil]]
    ]
  )

  EncodedRegistry.register(
    :class => SubjectAreaType,
    :schema_type => XSD::QName.new(NsV10, "SubjectAreaType"),
    :schema_element => [
      ["displayName", nil],
      ["subjectCode", nil]
    ]
  ...
  EncodedRegistry.register(
    ...
    :schema_type => XSD::QName.new(NsV10, "GetDbMetadataReqPayloadType"),
    :schema_element => [
      ["cidQualifier", "CIDQualifierType", [0, 1]],
      ["absMetSource", "AbsMetSourceType"],
      ["responseStyle", "ResponseStyleType"],
  ...
  EncodedRegistry.register(
    ...
    :schema_type => XSD::QName.new(NsV10, "GetDbMetadataType"),
    :schema_element => [
  ...
  EncodedRegistry.register(
    ...
    :schema_type => XSD::QName.new(NsV10, "GetDbMetadataRspPayloadType"),
    :schema_element => [
      ["cacheInfo", "CacheInfoType", [0, 1]],
  ...
  EncodedRegistry.register(
    ...
    :schema_type => XSD::QName.new(NsV10, "GetDbMetadataResponseType"),
    :schema_element => [
      ["status", "MetaDataStatusType"],
  ...
  EncodedRegistry.register(
    ...
    :schema_type => XSD::QName.new(NsV10, "DbInfoListType"),
    :schema_element => [
  ...
  EncodedRegistry.register(
    :class => DbInfoType,
    :schema_type => XSD::QName.new(NsV10, "DbInfoType"),
    :schema_element => [
      ["collectionList", "CollectionListType", [0, 1]],
      ["dbItem", "DbItemType"],
      ["smi", nil, [0, 1]],
  ...
  EncodedRegistry.register(
    ...
    :schema_type => XSD::QName.new(NsV10, "GetLinkDataReqPayloadType"),
    :schema_element => [
      ["cidQualifier", "CIDQualifierType", [0, 1]],
      ["absMetSource", "AbsMetSourceType"],
      ["responseStyle", "ResponseStyleType"],
  ...
  EncodedRegistry.register(
    ...
    :schema_type => XSD::QName.new(NsV10, "GetLinkDataType"),
    :schema_element => [
  ...
  EncodedRegistry.register(
    ...
    :schema_type => XSD::QName.new(NsV10, "GetLinkDataRspPayloadType"),
    :schema_element => [
  ...
  EncodedRegistry.register(
    ...
    :schema_type => XSD::QName.new(NsV10, "CitedLinkDataListType"),
    :schema_element => [
  ...
  EncodedRegistry.register(
    ...
    :schema_type => XSD::QName.new(NsV10, "CitedLinkDataType"),
    :schema_element => [
  ...
  EncodedRegistry.register(
    :class => LinkDataType,
    :schema_type => XSD::QName.new(NsV10, "LinkDataType"),
    :schema_element => [
      ["collectionList", "CollectionListType", [0, 1]],
  ...
  EncodedRegistry.register(
    :class => DbItemType,
    :schema_type => XSD::QName.new(NsV10, "DbItemType"),
    :schema_element => [
      ["dbName", nil, [0, 1]],
      ["dbUrl", nil, [0, 1]],
      ["coverageRange", "CoverageRangeType[]", [0, nil]]
  ...
  EncodedRegistry.register(
    ...
    :schema_type => XSD::QName.new(NsV10, "GetLinkDataResponseType"),
    :schema_element => [
      ["status", "MetaDataStatusType"],
  ...
  EncodedRegistry.register(
    ...
    :schema_type => XSD::QName.new(NsV10, "GetCitedByCountType"),
    :schema_element => [
  ...
  EncodedRegistry.register(
    ...
    :schema_type => XSD::QName.new(NsV10, "GetCitedByCountRspPayloadType"),
    :schema_element => [
  ...
  EncodedRegistry.register(
    ...
    :schema_type => XSD::QName.new(NsV10, "CitedByCountListType"),
    :schema_element => [
  ...
  EncodedRegistry.register(
    ...
    :schema_type => XSD::QName.new(NsV10, "CitedByCountType"),
    :schema_element => [
      ["inputKey", "InputKeyType"],
  ...
  EncodedRegistry.register(
    ...
    :schema_type => XSD::QName.new(NsV10, "CitedByCountItemType"),
    :schema_element => [
      ["eid", nil],
      ["scopusID", nil],
      ["citedByCount", "SOAP::SOAPDecimal"]
  ...
  EncodedRegistry.register(
    ...
    :schema_type => XSD::QName.new(NsV10, "GetCitedByCountResponseType"),
    :schema_element => [
      ["status", "MetaDataStatusType"],
  ...
  EncodedRegistry.register(
    :class => TopicListType,
    :schema_type => XSD::QName.new(NsV10, "TopicListType"),
    :schema_element => [
  ...
  EncodedRegistry.register(
    ...
    :schema_type => XSD::QName.new(NsV10, "GetTopicsRspPayloadType"),
    :schema_element => [
      ["cacheInfo", "CacheInfoType", [0, 1]],
  ...
  EncodedRegistry.register(
    :class => TopicType,
    :schema_type => XSD::QName.new(NsV10, "TopicType"),
    :schema_element => [
      ["collectionList", "CollectionListType", [0, 1]],
      ["topicId", nil],
      ["topicName", nil]
  ...
  EncodedRegistry.register(
    ...
    :schema_type => XSD::QName.new(NsV10, "GetTopicsReqPayloadType"),
    :schema_element => [
      ["cidQualifier", "CIDQualifierType", [0, 1]],
      ["absMetSource", "AbsMetSourceType"],
      ["responseStyle", "ResponseStyleType"],
  ...
  EncodedRegistry.register(
    :class => GetTopicsType,
    :schema_type => XSD::QName.new(NsV10, "GetTopicsType"),
    :schema_element => [
  ...
  EncodedRegistry.register(
    ...
    :schema_type => XSD::QName.new(NsV10, "GetTopicsResponseType"),
    :schema_element => [
      ["status", "MetaDataStatusType"],
  ...
  EncodedRegistry.register(
    ...
    :schema_type => XSD::QName.new(NsV10, "IsCacheCurrentReqPayloadType"),
    :schema_element => [
  ...
  EncodedRegistry.register(
    ...
    :schema_type => XSD::QName.new(NsV10, "IsCacheCurrentType"),
    :schema_element => [
  ...
  EncodedRegistry.register(
    ...
    :schema_type => XSD::QName.new(NsV10, "IsCacheCurrentRspPayloadType"),
    :schema_element => [
  ...
  EncodedRegistry.register(
    ...
    :schema_type => XSD::QName.new(NsV10, "IsCacheCurrentResponseType"),
    :schema_element => [
      ["status", "MetaDataStatusType"],
  ...
  EncodedRegistry.register(
    ...
    :schema_type => XSD::QName.new(NsV10, "GetSourceInfoRspPayloadType"),
    :schema_element => [
      ["cacheInfo", "CacheInfoType", [0, 1]],
      ["metricsTimestamp", "SOAP::SOAPString", [0, 1]],
  ...
  EncodedRegistry.register(
    ...
    :schema_type => XSD::QName.new(NsV10, "SourceInfoListType"),
    :schema_element => [
  ...
  EncodedRegistry.register(
    ...
    :schema_type => XSD::QName.new(NsV10, "SourceInfoType"),
    :schema_element => [
  ...
  EncodedRegistry.register(
    ...
    :schema_type => XSD::QName.new(NsV10, "VolumePairType"),
    :schema_element => [
      ["volumeFirst", nil],
      ["volumeLast", nil, [0, 1]]
    ]
  ...
  EncodedRegistry.register(
    ...
    :schema_type => XSD::QName.new(NsV10, "IssueInfoListType"),
    :schema_element => [
  ...
  EncodedRegistry.register(
    :class => IssueInfoType,
    :schema_type => XSD::QName.new(NsV10, "IssueInfoType"),
    :schema_element => [
  ...
  EncodedRegistry.register(
    ...
    :schema_type => XSD::QName.new(NsV10, "GetSourceInfoResponseType"),
    :schema_element => [
      ["status", "MetaDataStatusType"],
  ...
  EncodedRegistry.register(
    ...
    :schema_type => XSD::QName.new(NsV10, "GetSourceInfoType"),
    :schema_element => [
  ...
  EncodedRegistry.register(
    ...
    :schema_type => XSD::QName.new(NsV10, "GetSourceInfoReqPayloadType"),
    :schema_element => [
      ["cidQualifier", "CIDQualifierType", [0, 1]],
      ["absMetSource", "AbsMetSourceType"],
      ["responseStyle", "ResponseStyleType"],
  ...
  EncodedRegistry.register(
    ...
    :schema_type => XSD::QName.new(NsV10, "GetIDsRequestType"),
    :schema_element => [
  ...
  EncodedRegistry.register(
    ...
    :schema_type => XSD::QName.new(NsV10, "GetIDsRequestPayloadType"),
    :schema_element => [
      ["responseStyle", "ResponseStyleType"],
      ["dataResponseStyle", "DataResponseType"],
      ["keys", ["KeyType[]", XSD::QName.new(NsV10, "Keys")], [1, nil]]
    ]
  )

  EncodedRegistry.register(
    :class => KeyType,
    :schema_type => XSD::QName.new(NsV10, "KeyType"),
    :schema_element => [
      ["clientCRF", nil],
      ["bibkeys", [nil, XSD::QName.new(NsV10, "Bibkeys")], [0, 1]]
    ]
  )

  EncodedRegistry.register(
    :class => GetIDsResponseType,
    :schema_type => XSD::QName.new(NsV10, "GetIDsResponseType"),
    :schema_element => [
      ["status", "MetaDataStatusType"],
  ...
  EncodedRegistry.register(
    ...
    :schema_type => XSD::QName.new(NsV10, "GetIDsResponsePayloadType"),
    :schema_element => [
      ["dataResponseStyle", "DataResponseType"],
      ["stringBlob", nil, [0, 1]],
      ["iDList", ["IDListType", XSD::QName.new(NsV10, "IDList")], [0, 1]]
    ]
  )

  EncodedRegistry.register(
    :class => IDListType,
    :schema_type => XSD::QName.new(NsV10, "IDListType"),
    :schema_element => [
      ["iDItem", ["IDItemType[]", XSD::QName.new(NsV10, "IDItem")], [0, nil]]
    ]
  )

  EncodedRegistry.register(
    :class => IDItemType,
    :schema_type => XSD::QName.new(NsV10, "IDItemType"),
    :schema_element => [
      ["inputKey", "KeyType"],
      ["scopusID", ["[]", XSD::QName.new(NsV10, "ScopusID")], [1, nil]]
    ]
  )

  EncodedRegistry.register(
    :class => GetSourceYearInfoRspPayloadType,
    :schema_type => XSD::QName.new(NsV10, "GetSourceYearInfoRspPayloadType"),
    :schema_element => [
      ["cacheInfo", "CacheInfoType", [0, 1]],
  ...
  EncodedRegistry.register(
    ...
    :schema_type => XSD::QName.new(NsV10, "SourceYearInfoListType"),
    :schema_element => [
  ...
  EncodedRegistry.register(
    ...
    :schema_type => XSD::QName.new(NsV10, "SourceYearInfoType"),
    :schema_element => [
      ["abstractsId", nil, [0, 1]],
      ["displayName", nil],
      ["sourceType", nil],
  ...
  EncodedRegistry.register(
    ...
    :schema_type => XSD::QName.new(NsV10, "YearInfoListType"),
    :schema_element => [
  ...
  EncodedRegistry.register(
    :class => YearInfoType,
    :schema_type => XSD::QName.new(NsV10, "YearInfoType"),
    :schema_element => [
      ["year", "SOAP::SOAPInteger", [0, 1]],
      ["citeCount", "SOAP::SOAPInteger", [0, 1]],
      ["publicationCount", "SOAP::SOAPInteger", [0, 1]],
      ["zeroCites", "SOAP::SOAPString", [0, 1]],
      ["zeroCitesPercent", "SOAP::SOAPString", [0, 1]],
      ["citeCountSCE", "SOAP::SOAPString", [0, 1]],
      ["zeroCitesSCE", "SOAP::SOAPString", [0, 1]],
      ["zeroCitesPercentSCE", "SOAP::SOAPString", [0, 1]],
      ["revPercent", "SOAP::SOAPString", [0, 1]]
    ]
  )

  EncodedRegistry.register(
    :class => GetSourceYearInfoResponseType,
    :schema_type => XSD::QName.new(NsV10, "GetSourceYearInfoResponseType"),
    :schema_element => [
      ["status", "MetaDataStatusType"],
  ...
  EncodedRegistry.register(
    ...
    :schema_type => XSD::QName.new(NsV10, "GetSourceYearInfoType"),
    :schema_element => [
  ...
  EncodedRegistry.register(
    ...
    :schema_type => XSD::QName.new(NsV10, "GetSourceYearInfoReqPayloadType"),
    :schema_element => [
      ["cidQualifier", "CIDQualifierType", [0, 1]],
      ["absMetSource", "AbsMetSourceType"],
      ["responseStyle", "ResponseStyleType"],
  ...
  EncodedRegistry.register(
    ...
    :schema_type => XSD::QName.new(NsV10, "AbsMetSourceType")
  )

  EncodedRegistry.register(
    :class => AbsMetCacheType,
    :schema_type => XSD::QName.new(NsV10, "AbsMetCacheType")
  )

  EncodedRegistry.register(
    :class => NoDisplayType,
    :schema_type => XSD::QName.new(NsV10, "NoDisplayType")
  )

  EncodedRegistry.register(
    :class => SelfCitationType,
    :schema_type => XSD::QName.new(NsV10, "SelfCitationType")
  )
  ...
  LiteralRegistry.register(
    :class => GetPublishersType,
    :schema_name => XSD::QName.new(NsV10, "getPublishers"),
    :schema_element => [
      ["getPublishersReqPayload", "GetPublishersReqPayloadType"]
    ]
  )
  ...
  LiteralRegistry.register(
    :class => GetPublishersResponseType,
    :schema_name => XSD::QName.new(NsV10, "getPublishersResponse"),
    :schema_element => [
      ["status", "MetaDataStatusType"],
      ["getPublishersRspPayload", "GetPublishersRspPayloadType", [0, 1]]
    ]
  ...
  LiteralRegistry.register(
    :class => GetSourceMetadataType,
    :schema_name => XSD::QName.new(NsV10, "getSourceMetadata"),
    :schema_element => [
      ["getSourceMetadataReqPayload", "GetSourceMetadataReqPayloadType"]
    ]
  )
  ...
  LiteralRegistry.register(
    :class => GetSourceMetadataResponseType,
    :schema_name => XSD::QName.new(NsV10, "getSourceMetadataResponse"),
    :schema_element => [
      ["status", "MetaDataStatusType"],
      ["getSourceMetadataRspPayload", "GetSourceMetadataRspPayloadType", [0, 1]]
    ]
  ...
  LiteralRegistry.register(
    :class => GetDbMetadataType,
    :schema_name => XSD::QName.new(NsV10, "getDbMetadata"),
    :schema_element => [
      ["getDbMetadataReqPayload", "GetDbMetadataReqPayloadType"]
    ]
  )
  ...
  LiteralRegistry.register(
    :class => GetDbMetadataResponseType,
    :schema_name => XSD::QName.new(NsV10, "getDbMetadataResponse"),
    :schema_element => [
      ["status", "MetaDataStatusType"],
      ["getDbMetadataRspPayload", "GetDbMetadataRspPayloadType", [0, 1]]
    ]
  ...
  LiteralRegistry.register(
    :class => GetLinkDataType,
    :schema_name => XSD::QName.new(NsV10, "getLinkData"),
    :schema_element => [
      ["getLinkDataReqPayload", "GetLinkDataReqPayloadType"]
    ]
  )
  ...
  LiteralRegistry.register(
    :class => GetLinkDataResponseType,
    :schema_name => XSD::QName.new(NsV10, "getLinkDataResponse"),
    :schema_element => [
      ["status", "MetaDataStatusType"],
      ["getLinkDataRspPayload", "GetLinkDataRspPayloadType", [0, 1]]
    ]
  ...
  LiteralRegistry.register(
    :class => GetCitedByCountType,
    :schema_name => XSD::QName.new(NsV10, "getCitedByCount"),
    :schema_element => [
      ["getCitedByCountReqPayload", "GetLinkDataReqPayloadType"]
    ]
  )
  ...
  LiteralRegistry.register(
    :class => GetCitedByCountResponseType,
    :schema_name => XSD::QName.new(NsV10, "getCitedByCountResponse"),
    :schema_element => [
      ["status", "MetaDataStatusType"],
      ["getCitedByCountRspPayload", "GetCitedByCountRspPayloadType", [0, 1]]
    ]
  ...
  LiteralRegistry.register(
    :class => GetTopicsType,
    :schema_name => XSD::QName.new(NsV10, "getTopics"),
    :schema_element => [
      ["getTopicsReqPayload", "GetTopicsReqPayloadType"]
    ]
  )
  ...
  LiteralRegistry.register(
    :class => GetTopicsResponseType,
    :schema_name => XSD::QName.new(NsV10, "getTopicsResponse"),
    :schema_element => [
      ["status", "MetaDataStatusType"],
      ["getTopicsRspPayload", "GetTopicsRspPayloadType"]
    ]
  ...
  LiteralRegistry.register(
    :class => IsCacheCurrentType,
    :schema_name => XSD::QName.new(NsV10, "isCacheCurrent"),
    :schema_element => [
      ["isCacheCurrentReqPayload", "IsCacheCurrentReqPayloadType"]
    ]
  )
  ...
  LiteralRegistry.register(
    :class => IsCacheCurrentResponseType,
    :schema_name => XSD::QName.new(NsV10, "isCacheCurrentResponse"),
    :schema_element => [
      ["status", "MetaDataStatusType"],
      ["isCacheCurrentRspPayload", "IsCacheCurrentRspPayloadType", [0, 1]]
    ]
  ...
  LiteralRegistry.register(
    :class => GetSourceInfoResponseType,
    :schema_name => XSD::QName.new(NsV10, "getSourceInfoResponse"),
    :schema_element => [
      ["status", "MetaDataStatusType"],
      ["getSourceInfoRspPayload", "GetSourceInfoRspPayloadType", [0, 1]]
    ]
  ...
  LiteralRegistry.register(
    :class => GetSourceInfoType,
    :schema_name => XSD::QName.new(NsV10, "getSourceInfo"),
    :schema_element => [
      ["getSourceInfoReqPayload", "GetSourceInfoReqPayloadType"]
    ]
  )
  ...
  LiteralRegistry.register(
    :class => GetEIDsRequestType,
    :schema_name => XSD::QName.new(NsV10, "getEIDs"),
    :schema_element => [
      ["getEIDsRequestPayload", ["GetEIDsRequestPayloadType", XSD::QName.new(nil, "getEIDsRequestPayload")]]
    ]
  )
  ...
  LiteralRegistry.register(
    :class => GetEIDsResponseType,
    :schema_name => XSD::QName.new(NsV10, "getEIDsResponse"),
    :schema_element => [
      ["status", ["MetaDataStatusType", XSD::QName.new(nil, "status")]],
      ["getEIDsResponsePayload", ["GetEIDsResponsePayloadType", XSD::QName.new(nil, "getEIDsResponsePayload")], [0, 1]]
    ]
  ...
  LiteralRegistry.register(
    :class => GetIDsRequestType,
    :schema_name => XSD::QName.new(NsV10, "getIDs"),
    :schema_element => [
      ["getIDsRequestPayload", "GetIDsRequestPayloadType"]
    ]
  )
  ...
  LiteralRegistry.register(
    :class => GetIDsResponseType,
    :schema_name => XSD::QName.new(NsV10, "getIDsResponse"),
    :schema_element => [
      ["status", "MetaDataStatusType"],
      ["getIDsResponsePayload", "GetIDsResponsePayloadType", [0, 1]]
    ]
  ...
  LiteralRegistry.register(
    :class => GetSourceYearInfoResponseType,
    :schema_name => XSD::QName.new(NsV10, "getSourceYearInfoResponse"),
    :schema_element => [
      ["status", "MetaDataStatusType"],
      ["getSourceYearInfoRspPayload", "GetSourceYearInfoRspPayloadType", [0, 1]]
    ]
  ...
  LiteralRegistry.register(
    :class => GetSourceYearInfoType,
    :schema_name => XSD::QName.new(NsV10, "getSourceYearInfo"),
    :schema_element => [
      ["getSourceYearInfoReqPayload", "GetSourceYearInfoReqPayloadType"]
    ]
  )
