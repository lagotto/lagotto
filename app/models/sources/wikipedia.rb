    ...
    LANGUAGES.each do |lang|
      ...
      20.times do
        ...
        until offset < 0    
          ...
          raise Net::HTTPServerError, "#{display_name} #{results['error']['info']}" unless results['error'].blank?
      ...
      raise Net::HTTPServerError, "#{display_name} missed #{missing_count} out of #{lang_total} event(s) for host #{host}" if missing_count != 0
