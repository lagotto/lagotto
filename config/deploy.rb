...
set :npm_target_path, -> { release_path.join('vendor') }
...
set :linked_dirs, %w{ log tmp/pids tmp/sockets tmp/files tmp/reports vendor/bundle vendor/node_modules vendor/bower_components }
