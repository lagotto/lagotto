...
env_vars = %w{ DB_USERNAME DB_HOST HOSTNAME SERVERNAME SERVERS SITENAME COUCHDB_URL ADMIN_EMAIL WORKERS API_KEY SECRET_KEY_BASE MAIL_ADDRESS MAIL_PORT MAIL_DOMAIN OMNIAUTH }
