...
env_vars = %w{ DB_USERNAME HOSTNAME SERVERNAME SERVERS SITENAME MODE ADMIN_EMAIL CONCURRENCY API_KEY SECRET_KEY_BASE MAIL_ADDRESS MAIL_PORT MAIL_DOMAIN OMNIAUTH }
