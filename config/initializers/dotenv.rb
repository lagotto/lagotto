...
env_vars = %w{ DB_USERNAME HOSTNAME SERVERNAME SERVERS SITENAME COUCHDB_URL ADMIN_EMAIL CONCURRENCY API_KEY SECRET_KEY_BASE MAIL_ADDRESS MAIL_PORT MAIL_DOMAIN OMNIAUTH }
