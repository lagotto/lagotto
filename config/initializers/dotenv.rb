...
env_vars = %w{ DATABASE_URL HOSTNAME SERVERNAME SERVERS SITENAME ADMIN_EMAIL CONCURRENCY API_KEY SECRET_KEY_BASE MAIL_ADDRESS MAIL_PORT MAIL_DOMAIN OMNIAUTH SOLR_URL }
