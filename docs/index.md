...
## For Users
By signing up for an API key with a [Mozilla Persona](http://www.mozilla.org/en-US/persona/) account here you get direct access to the underlying data via the [API](/docs/api).
