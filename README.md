...
## More Documentation
There is extensive documentation - including installation instructions - at the (project website)[https://articlemetrics.github.io].
...
## Copyright
Copyright (c) 2009-2014 by Public Library of Science. See [LICENSE](https://github.com/articlemetrics/alm/blob/master/LICENSE.md) for details.
