...
def install_ruby_dependencies(rubie)
  ...
  when /^ruby-/, /^ree-/, /^rbx-/, /^kiji/
    case node['platform']
      when "debian","ubuntu"
        # TODO: ubuntu lucid doesn't know about libxslt-dev and ncurses-dev, using libxslt1-dev and libncurses5-dev instead
        pkgs  = %w{ build-essential openssl libreadline6 libreadline6-dev
                    ...
                    libncurses5-dev automake libtool bison ssl-cert }
